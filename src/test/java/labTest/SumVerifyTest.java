...
public class SumVerifyTest {
        ...
        @Test(dataProvider = "products", testName = "Order the most expensive item", description = "After searching for the most expensive product in a given category, with a given brand and adding it to the shopping cart, the name of the product and its price must match the name and price indicated on the product card")
